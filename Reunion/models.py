...
class PV(models.Model):
    reunion = models.OneToOneField(
        Reunion, on_delete=models.CASCADE, primary_key=True, related_name="pv"
    )
...
class Point(models.Model):
    ...
    reunion = models.ForeignKey(
        Reunion, on_delete=models.CASCADE, related_name="points"
    )
...
class Enregistrement(models.Model):
    point = models.OneToOneField(
        Point, on_delete=models.CASCADE, related_name="enregistrement"
    )
...
class Invitation(models.Model):
    ...
    collaborateur = models.ForeignKey(
        ...
        related_name="collaborateur_invitations",
